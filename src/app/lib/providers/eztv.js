(function (App) {
	...
	var queryTorrents = function (filters) {
		...
		var url = App.Settings.get('tvshowApiEndpoint') + 'shows/' + filters.page + '?' + querystring.stringify(params).replace(/%25%20/g, '%20');
	...
	var queryTorrent = function (torrent_id, old_data) {
		return Q.Promise(function (resolve, reject) {
			var url = App.Settings.get('tvshowApiEndpoint') + 'show/' + torrent_id;
