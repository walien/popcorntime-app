(function (App) {
	...
	var queryTorrents = function (filters) {
		...
		var url = App.Settings.get('yifyApiEndpoint') + 'list.json?' + querystring.stringify(params).replace(/%E2%80%99/g, '%27');
	...
	var queryTorrent = function (torrent_id, old_data) {
		return Q.Promise(function (resolve, reject) {
			...
			var url = App.Settings.get('yifyApiEndpoint') + 'listimdb.json?' + querystring.stringify(params).replace(/%E2%80%99/g, '%27');
