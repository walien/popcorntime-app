...
Localization.filterSubtitle = function (langs) {
    var filteredLang = {};
    _.each(langs, function (data, lang) {
        var langInfo = Localization.langcodes[lang];
...
Localization.allTranslations = ['en', 'ar', 'az', 'bg', 'bn', 'bs', 'ca', 'cs', 'da', 'de', 'el', 'en-gb', 'en@pirate', 'es', 'es-ar', 'es-mx', 'et', 'eu', 'fa', 'fi', 'fr', 'gl', 'he', 'hr', 'hu', 'id', 'is', 'it', 'ko', 'ku-iq', 'lt', 'lv', 'mk', 'nb', 'nl', 'pl', 'pt', 'pt-br', 'ro', 'ru', 'si', 'sk', 'sl', 'sr', 'sv', 'th', 'tr', 'uk', 'vi', 'zh-cn', 'zh-tw'];
