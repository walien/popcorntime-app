...
<div class="dropdown-toggle left playerchoice" data-toggle="dropdown">
  <img class="imgplayerchoice" src="<%=App.Settings.get('theme_path')%>/assets/images/icons/local-icon.png"/>
...
<ul class="dropdown-menu playerchoicemenu" role="menu">
  <% _.each(items, function(item){ %>
	<li id ="player-<%= item.id %>">
	  <a href="#"> <%= item.name %>
		<img class="playerchoiceicon" src="<%=App.Settings.get('theme_path')%>/assets/images/icons/<%= item.type %>-icon.png"/>
	</a>
	</li>
  <% }); %>
</ul>
