...
<img class="icon-disclaimer" src="<%=App.Settings.get('theme_path')%>/assets/images/icon.png">
<div class="disclaimer-state">
	<div class="disclaimer-content">
		...
		<div class="disclaimer-text">
			...
			<p>ALL MOVIES ARE NOT HOSTED IN ANY SERVER AND ARE STREAMED USING THE P2P BIT TORRENT PROTOCOL. ALL MOVIES ARE PULLED IN FROM THE OPEN PUBLIC APIS. BY WATCHING A MOVIE WITH THIS APPLICATION YOU MIGHT BE COMMITING COPYRIGHT VIOLATIONS DEPENDING ON YOUR COUNTRY´S LAWS. WE DO NOT TAKE ANY RESPONSABILITIES.<br><br></p>
